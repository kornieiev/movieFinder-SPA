...
// тут надо будет сделать заготовки с именами под нужный запрос и передавать имя этого запроса в функцию вызова фетч
...
const URL = {
  ...
  searchMovie:
    'https://api.themoviedb.org/3/search/movie?include_adult=false&language=en-US&page=1',
  detailsMovie: 'https://api.themoviedb.org/3/movie/movie_id?language=en-US',
  creditsMovie:
    'https://api.themoviedb.org/3/movie/movie_id/credits?language=en-US',
  reviewsMovie:
    'https://api.themoviedb.org/3/movie/movie_id/reviews?language=en-US&page=1',
